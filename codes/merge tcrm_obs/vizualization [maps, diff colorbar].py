# -*- coding: utf-8 -*-
"""
Created on Wed Oct 29 19:11:10 2025
...
# ---------------------------
# Columns to plot (two groups)
# ---------------------------
COLS_TO_PLOT = [
    "TCRM_31",  # tcrm gust
    "TCRM_26",  # tcrm pressure
    "OBS_9",    # obs gust
    "OBS_13",   # obs pressure
]
...
# ==========================================================
def wspd_lc():
    """Wind speed / pressure color scale."""
    thresholds = [
...
def generic_anom_lc():
    """Anomaly color scale (symmetric, red-blue)."""
